...
public class SettingsTest {
    ...
    public void testSet() {
        ...
        // Invald values...
        error = null; try { settings.setProperty(null, "myKey", ""); } catch (IllegalArgumentException ex) { error = ex; }
        Assert.assertTrue(error.getMessage().toLowerCase().contains("null/empty value"));
        Assert.assertNotNull(error);

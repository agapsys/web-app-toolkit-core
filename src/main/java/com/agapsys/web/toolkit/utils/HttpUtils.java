...
public class HttpUtils {
	...
	private static final HttpUtils  SINGLETON = new HttpUtils();
	 ...
	 */
	public String getOriginIp(HttpServletRequest req) {
	 ...
	 * @param req HTTP request.
	 */
	public String getOriginUserAgent(HttpServletRequest req) {
	 ...
	 */
	public void addCookie(HttpServletResponse resp, String name, String value, int maxAge, String path) {
	 ...
	 * @param maxAge an integer specifying the maximum age of the cookie in seconds; if negative, means the cookie is not stored; if zero, deletes the cookie.
	 */
	public final void addCookie(HttpServletRequest req, HttpServletResponse resp, String name, String value, int maxAge) {
	 ...
	 * @param path cookie path ((usually {@linkplain HttpServletRequest#getContextPath()}).
	 */
	public void removeCookie(HttpServletResponse resp, String name, String path) {
	 ...
	 * @param name name of the cookie to be removed.
	 */
	public void removeCookie(HttpServletRequest req, HttpServletResponse resp, String name) {
	 ...
	 */
	public String getOptionalParameter(HttpServletRequest req, String paramName, String defaultValue) {
	 ...
	 */
	public final String getMandatoryParameter(HttpServletRequest req, String paramName) throws BadRequestException {
	 ...
	 * @throws BadRequestException if parameter is not contained in given request.
	 */
	public String getMandatoryParameter(HttpServletRequest req, String paramName, String errorMessage, Object...errMsgArgs) throws BadRequestException {
